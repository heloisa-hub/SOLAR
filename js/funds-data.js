...
var SOLAR_CAPITAL_FUNDS = [
  {
    ...
    classePrincipal: "Sênior6",
    janelaResgate: "Sênior5 e Sênior6 em operação; sem série nova aberta a aportes no momento (prevista para set/2026, segundo o cliente em 28/08)",
    inadimplenciaCvmPercentPL: 2.41,
    classes: [
      { nome: "Sênior6", percentPL: 49.85, rating: "brA(sf)", benchmark: "CDI + 4,00% a.a.", dataInicioCota: "2024-12-11", plReais: "R$ 50,12 milhões", mes: 1.58, ano: 10.61, tresMeses: 4.48, seisMeses: 8.98, dozeMeses: 19.3, desdeInicio: 32.55, cdiMes: 129.9, cdiAno: 130.4, cdi3m: 130.1, cdi6m: 130.2, cdi12m: 131.2, cdiInicio: 133.6, historicoMensal: [{ mes: "2024-12", rentabilidade: 9.78 }, { mes: "2025-01", rentabilidade: 20.91 }, { mes: "2025-02", rentabilidade: 22.68 }, { mes: "2025-03", rentabilidade: 36.17 }, { mes: "2025-04", rentabilidade: 36.12 }, { mes: "2025-05", rentabilidade: 36.49 }, { mes: "2025-06", rentabilidade: 37.12 }, { mes: "2025-07", rentabilidade: 1.64 }, { mes: "2025-08", rentabilidade: 1.5 }, { mes: "2025-09", rentabilidade: 1.57 }, { mes: "2025-10", rentabilidade: 1.64 }, { mes: "2025-11", rentabilidade: 1.35 }, { mes: "2025-12", rentabilidade: 1.57 }, { mes: "2026-02", rentabilidade: 1.28 }, { mes: "2026-03", rentabilidade: 1.56 }, { mes: "2026-04", rentabilidade: 1.41 }, { mes: "2026-05", rentabilidade: 1.39 }, { mes: "2026-06", rentabilidade: 1.45 }, { mes: "2026-07", rentabilidade: 1.58 }] },
      { nome: "Sênior5", percentPL: 10.03, rating: "brA(sf)", benchmark: "CDI + 4,00% a.a.", dataInicioCota: "2023-11-08", plReais: "R$ 10,09 milhões", mes: 1.58, ano: 10.61, tresMeses: 4.48, seisMeses: 8.98, dozeMeses: 19.3, desdeInicio: 54.91, cdiMes: 129.9, cdiAno: 130.4, cdi3m: 130.1, cdi6m: 130.2, cdi12m: 131.2, cdiInicio: 139.9, historicoMensal: [{ mes: "2023-11", rentabilidade: 3.3 }, { mes: "2023-12", rentabilidade: 5.68 }, { mes: "2024-01", rentabilidade: 5.71 }, { mes: "2024-02", rentabilidade: 5.69 }, { mes: "2024-03", rentabilidade: 5.67 }, { mes: "2024-04", rentabilidade: 5.96 }, { mes: "2024-05", rentabilidade: 11.85 }, { mes: "2024-06", rentabilidade: 11.9 }, { mes: "2024-07", rentabilidade: 14.05 }, { mes: "2024-08", rentabilidade: 18.73 }, { mes: "2024-09", rentabilidade: 20.64 }, { mes: "2024-10", rentabilidade: 26.1 }, { mes: "2024-11", rentabilidade: 28.55 }, { mes: "2024-12", rentabilidade: 27.91 }, { mes: "2025-01", rentabilidade: 26.83 }, { mes: "2025-02", rentabilidade: 29.11 }, { mes: "2025-03", rentabilidade: 29.11 }, { mes: "2025-04", rentabilidade: 29.08 }, { mes: "2025-05", rentabilidade: 29.37 }, { mes: "2025-06", rentabilidade: 28.22 }, { mes: "2025-07", rentabilidade: 1.64 }, { mes: "2025-08", rentabilidade: 1.5 }, { mes: "2025-09", rentabilidade: 1.57 }, { mes: "2025-10", rentabilidade: 1.64 }, { mes: "2025-11", rentabilidade: 1.35 }, { mes: "2025-12", rentabilidade: 1.57 }, { mes: "2026-02", rentabilidade: 1.28 }, { mes: "2026-03", rentabilidade: 1.56 }, { mes: "2026-04", rentabilidade: 1.41 }, { mes: "2026-05", rentabilidade: 1.39 }, { mes: "2026-06", rentabilidade: 1.45 }, { mes: "2026-07", rentabilidade: 1.58 }] },
      { nome: "Mezanino", percentPL: 0.0, rating: "brBBB-(sf)", benchmark: "CDI + 5,50% a.a.", dataInicioCota: "2023-07-03", plReais: "R$ 0", mes: 9.89, ano: 3.33, tresMeses: 8.15, seisMeses: 19.25, dozeMeses: 68.9, desdeInicio: null, cdiMes: 121.5, cdiAno: 96.6, cdi3m: 118.1, cdi6m: 130.9, cdi12m: 151.7, cdiInicio: null, historicoMensal: [{ mes: "2023-07", rentabilidade: 7.02 }, { mes: "2023-08", rentabilidade: 7.2 }, { mes: "2023-09", rentabilidade: 7.19 }, { mes: "2023-10", rentabilidade: 7.18 }, { mes: "2023-11", rentabilidade: 6.99 }, { mes: "2023-12", rentabilidade: 6.73 }, { mes: "2024-01", rentabilidade: 6.78 }, { mes: "2024-02", rentabilidade: 6.76 }, { mes: "2024-03", rentabilidade: 6.75 }, { mes: "2024-04", rentabilidade: 7.1 }, { mes: "2024-05", rentabilidade: 7.09 }, { mes: "2024-06", rentabilidade: 7.12 }, { mes: "2024-07", rentabilidade: 8.42 }, { mes: "2024-08", rentabilidade: 9.89 }, { mes: "2024-09", rentabilidade: 10.92 }, { mes: "2024-10", rentabilidade: 11.15 }, { mes: "2024-11", rentabilidade: 12.21 }, { mes: "2024-12", rentabilidade: 11.95 }, { mes: "2025-01", rentabilidade: 11.5 }, { mes: "2025-02", rentabilidade: 11.8 }, { mes: "2025-03", rentabilidade: 11.12 }, { mes: "2025-04", rentabilidade: 10.42 }, { mes: "2025-05", rentabilidade: 9.83 }, { mes: "2025-06", rentabilidade: 9.3 }, { mes: "2025-07", rentabilidade: 1.77 }, { mes: "2025-08", rentabilidade: 1.62 }, { mes: "2025-09", rentabilidade: 1.69 }, { mes: "2025-10", rentabilidade: 1.77 }, { mes: "2025-11", rentabilidade: 1.46 }, { mes: "2025-12", rentabilidade: 1.69 }, { mes: "2026-02", rentabilidade: 1.38 }, { mes: "2026-03", rentabilidade: 1.69 }, { mes: "2026-04", rentabilidade: 1.52 }, { mes: "2026-05", rentabilidade: 1.5 }, { mes: "2026-06", rentabilidade: 1.57 }, { mes: "2026-07", rentabilidade: 9.89 }] },
      { nome: "Subordinada", percentPL: 40.12, rating: "brB+(sf)", benchmark: null, dataInicioCota: "2018-10-25", plReais: "R$ 40,34 milhões", mes: 1.47, ano: 11.41, tresMeses: 3.36, seisMeses: 6.28, dozeMeses: 10.35, desdeInicio: 246.71, cdiMes: 120.7, cdiAno: 140.1, cdi3m: 97.6, cdi6m: 91.0, cdi12m: 70.3, cdiInicio: 246.3, historicoMensal: [{ mes: "2020-08", rentabilidade: 0.38 }, { mes: "2020-09", rentabilidade: 2.86 }, { mes: "2020-10", rentabilidade: 3.35 }, { mes: "2020-11", rentabilidade: 1.42 }, { mes: "2020-12", rentabilidade: 1.1 }, { mes: "2021-01", rentabilidade: 48.83 }, { mes: "2021-02", rentabilidade: 45.37 }, { mes: "2021-03", rentabilidade: 40.3 }, { mes: "2021-04", rentabilidade: 2.17 }, { mes: "2021-05", rentabilidade: 2.5 }, { mes: "2021-06", rentabilidade: 2.25 }, { mes: "2021-07", rentabilidade: 2.56 }, { mes: "2021-08", rentabilidade: 2.43 }, { mes: "2021-09", rentabilidade: 2.31 }, { mes: "2021-10", rentabilidade: 2.11 }, { mes: "2021-11", rentabilidade: 2.48 }, { mes: "2021-12", rentabilidade: 1.45 }, { mes: "2022-01", rentabilidade: 1.87 }, { mes: "2022-03", rentabilidade: 2.63 }, { mes: "2022-04", rentabilidade: 2.69 }, { mes: "2022-05", rentabilidade: 1.86 }, { mes: "2022-06", rentabilidade: 1.83 }, { mes: "2022-07", rentabilidade: 1.55 }, { mes: "2022-08", rentabilidade: 2.94 }, { mes: "2022-09", rentabilidade: 1.62 }, { mes: "2022-10", rentabilidade: 2.41 }, { mes: "2022-11", rentabilidade: 0.76 }, { mes: "2022-12", rentabilidade: 0.08 }, { mes: "2023-01", rentabilidade: 44.51 }, { mes: "2023-02", rentabilidade: 45.26 }, { mes: "2023-03", rentabilidade: 47.28 }, { mes: "2023-04", rentabilidade: 44.41 }, { mes: "2023-05", rentabilidade: 45.75 }, { mes: "2023-06", rentabilidade: 35.7 }, { mes: "2023-07", rentabilidade: 26.63 }, { mes: "2023-08", rentabilidade: 27.76 }, { mes: "2023-09", rentabilidade: 27.95 }, { mes: "2023-10", rentabilidade: 28.14 }, { mes: "2023-11", rentabilidade: 26.86 }, { mes: "2023-12", rentabilidade: 27.09 }, { mes: "2024-01", rentabilidade: 26.69 }, { mes: "2024-02", rentabilidade: 26.93 }, { mes: "2024-03", rentabilidade: 27.12 }, { mes: "2024-04", rentabilidade: 28.7 }, { mes: "2024-05", rentabilidade: 28.32 }, { mes: "2024-06", rentabilidade: 28.02 }, { mes: "2024-07", rentabilidade: 27.51 }, { mes: "2024-08", rentabilidade: 27.38 }, { mes: "2024-09", rentabilidade: 26.89 }, { mes: "2024-10", rentabilidade: 27.42 }, { mes: "2024-11", rentabilidade: 28.33 }, { mes: "2024-12", rentabilidade: 27.69 }, { mes: "2025-01", rentabilidade: 26.24 }, { mes: "2025-02", rentabilidade: 20.66 }, { mes: "2025-03", rentabilidade: 23.61 }, { mes: "2025-04", rentabilidade: 24.38 }, { mes: "2025-05", rentabilidade: 24.31 }, { mes: "2025-06", rentabilidade: 25.35 }, { mes: "2025-07", rentabilidade: -0.56 }, { mes: "2025-08", rentabilidade: 3.4 }, { mes: "2025-09", rentabilidade: 2.49 }, { mes: "2025-10", rentabilidade: 1.49 }, { mes: "2025-11", rentabilidade: -6.29 }, { mes: "2025-12", rentabilidade: -1.74 }, { mes: "2026-02", rentabilidade: 0.36 }, { mes: "2026-03", rentabilidade: 1.58 }, { mes: "2026-04", rentabilidade: 0.86 }, { mes: "2026-05", rentabilidade: 1.38 }, { mes: "2026-06", rentabilidade: 0.48 }, { mes: "2026-07", rentabilidade: 1.47 }] }
    ],
